...
au BufWritePre *.c,*.cpp,*.scss,*.es6,*.h,*.hs,*.js,*.lua,*.py,*.rb,*.opal,*.java,*.erb :%s/\s\+$//e

" set tab syntax for makefiles
au FileType make setlocal ts=8 sts=8 sw=8 noexpandtab

" set spaces for .js, .erb, .opal, .rb, .scss
au FileType es6,javascript,ruby,opal,eruby,scss setlocal ts=2 sts=2 sw=2 expandtab

" set spaces for .c, .h, .python, vue
au FileType c,h,python,vue setlocal ts=4 sts=4 sw=4 expandtab
